...
<!-- Carousel  -->
 ...
 <section class="py-5 white-section" id="introduction" >
   <div class="container">
     <h1 class="display-4 title"><?php echo $general_setting['Name'] ?> ,Rajkot.</h1>
   ...
   <div class="container"> 
           ...
           <p class="text-justify">This ornate, palatial tribute to Southern India's greatest empires -The pasific - overlooks 
               verdant foliage in the heart of rajkot. This luxury hotel offers one of the largest banqueting 
               facilities in India, 10 award winning F&B outlets, signature wellness experiences and more.It embodies the highest standards in Indian hospitality balanced with elegant restraint in a prime 
               property with distinct personality.The passific has 522 rooms and 78 luxuriously appointed service apartments- collectively 
               ...
               <blockquote class="blockquote">Ideal Location</blockquote>
			    <p class="text-justify"> The delights of this luxurious hotel are varied. As a fascinating 
                ...
                ,blue diamond in rajkot is within close proximity to many key areas of rajkot and is just 8
               ...
               <blockquote class="blockquote">Refined Artistry</blockquote><p class="text-justify">
   ...
   <section class="py-5 colored-section" id="grid" >
           ...
           <div class="row">
               ...
               <div class="box container text-center"><a href="login.php">
                  ...
                  </a> <center><h3>ACCOMMODATION</h3></center>
               ...
               <div class="row">
                   ...
                   <div class="box container text-center"><a href="login.php">
                    ...
                    </a>   <center><h2>SHORT BREAK</h2></center>
                   ...
                   <div class="box container text-center"><a href="login.php">
                     ...
                     </a>  <center><h2>SUITE SOJOURNS</h2></center>
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="carousel-item active">
      ...
      <div class="col-md-3" style="float:left">
       <div class="card mb-2 "><a href="login.php">
