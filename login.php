...
<div class="container">
    <div class="row align-items-center my-5">
        ...
        <div class="col-md-5 pr-lg-5 mb-5 mb-md-0">
            ...
            <p class="font-italic text-muted mb-0">Information provided below will be used to sign in to your Hotel blue diamond account.</p>
        ...
        <div class="text-center social-btn">
            <a href="https://www.facebook.com/" class="btn btn-secondary"><i class="fa fa-facebook"></i>&nbsp; Facebook</a>
            <a href="https://twitter.com/i/flow/login" class="btn btn-info"><i class="fa fa-twitter"></i>&nbsp; Twitter</a>
        </div>
    </form>
