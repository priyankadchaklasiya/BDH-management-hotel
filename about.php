...
<div class="intro py-5">
                ...
                <p class="text-center">Make the Most Of Your Time in Rajkot </p>
</div>
<div class="row pb-4">
<div class="col-md-4 col-sm-6">
<ul>
<li>Connect, create and innovate in the flexible meeting venues at our business hotel in Rajkot</li>
...
<div class="col-md-4 col-sm-6">
<ul>
<li>Host up to 1,200 in the largest, most sophisticated conference venue in downtown Rajkot</li>
...
<li>Impress your attendees with upscale hotel accommodations amid the best of downtown rajkot
...
<div class="bg-light pb-5 py-3">
  <div class="container py-6">
    <div class="row mb-4 pb-5">
      <div class="col-lg-5">
        <h2 class="display-4 font-weight-light">Our team member</h2>
      </div>
    </div>
        ...
        <div class="card about col-md-3 mt-70">
            <div class="card-content">
                <div class="card-body about-founder p-0">
                    ...
                    <div class="card-title"> Chaklasiya Priyanka<br /> </div>
        ...
        <div class="card about col-md-3 mt-70">
            <div class="card-content">
                <div class="card-body about-founder p-0">
                    ...
                    <div class="card-title">Urvi Aajugiya
<br /> </div>
                    <div class="card-subtitle">
